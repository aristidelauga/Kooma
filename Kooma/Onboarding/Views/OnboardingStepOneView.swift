...
struct OnboardingStepOneView: View {
    ...
    var body: some View {
		VStack(spacing: 0) {
			...
			NavigationLink(destination: OnboardingStepTwoView(hasCompletedOnboarding: $hasCompletedOnboarding), label: {
...
#Preview {
    OnboardingStepOneView(hasCompletedOnboarding: .constant(false))
}
